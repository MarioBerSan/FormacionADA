...
package body ada_main is
   ...
   E182 : Short_Integer; pragma Import (Ada, E182, "aula_E");
   E174 : Short_Integer; pragma Import (Ada, E174, "persona_model_E");
   E150 : Short_Integer; pragma Import (Ada, E150, "alumno_model_E");
   E184 : Short_Integer; pragma Import (Ada, E184, "profesor_model_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "profesor_model__finalize_spec");
      begin
         F1;
      end;
      E150 := E150 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "alumno_model__finalize_spec");
      begin
         F2;
      end;
      E174 := E174 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "persona_model__finalize_spec");
      begin
         F3;
      end;
      E176 := E176 - 1;
   ...
   begin
      ...
      E150 := E150 + 1;
      Profesor_Model'Elab_Spec;
      Profesor_Model'Elab_Body;
      E184 := E184 + 1;
   end adainit;
...
--  BEGIN Object file/option list
   --   C:\GNAT\CursoADA\11.Herencia\obj\aula.o
   --   C:\GNAT\CursoADA\11.Herencia\obj\persona_model.o
   --   C:\GNAT\CursoADA\11.Herencia\obj\alumno_model.o
   --   C:\GNAT\CursoADA\11.Herencia\obj\profesor_model.o
   --   C:\GNAT\CursoADA\11.Herencia\obj\main.o
   --   -LC:\GNAT\CursoADA\11.Herencia\obj\
   --   -LC:\GNAT\CursoADA\11.Herencia\obj\
